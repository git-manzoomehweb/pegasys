...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const topOfSearch = document.querySelector('.top-of-search-engine');
  const loader = document.querySelector('#search-box .search-engine-loader');

  if (!searchNav) {
   if(topOfSearch) topOfSearch.style.display = 'none';
